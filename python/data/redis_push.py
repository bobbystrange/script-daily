...
if __name__ == '__main__':
    ...
    parser.add_argument('-H', '--host',
                        dest='host', default='127.0.0.1', help='redis host, default is 127.0.0.1')
    parser.add_argument('-p', '--port',
                        dest='port', default=6379, help='redis port, default is 6379')
    parser.add_argument('-f', '--file',
                        dest='file', help='per line as a value')
    parser.add_argument('-t', '--type',
                        dest='type', default='list', choices=['list', 'set', 'zset'],
